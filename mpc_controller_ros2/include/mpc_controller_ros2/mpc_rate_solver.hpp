#ifndef MPC_CONTROLLER_ROS2_MPC_RATE_SOLVER_HPP_
#define MPC_CONTROLLER_ROS2_MPC_RATE_SOLVER_HPP_
...
#include "acados_solver_quadrotor_rate.h"
}

namespace mpc_controller_ros2 {

class MPCRateSolver : public MPCSolverBase {
public:
  MPCRateSolver(rclcpp::Logger logger);
  ~MPCRateSolver();

  // Implement pure virtual methods
  int getNx() const override { return QUADROTOR_RATE_NX; }
  int getNu() const override { return QUADROTOR_RATE_NU; }
  int getNy() const override { return QUADROTOR_RATE_NX + QUADROTOR_RATE_NU; }
  int getNyE() const override { return QUADROTOR_RATE_NX; }
  int getNHorizon() const override { return QUADROTOR_RATE_N; }  // Get from generated code
  ...
  quadrotor_rate_solver_capsule *getCapsule() { return capsule_; }

  std::vector<double> x_traj_;
  std::vector<double> u_traj_;

  quadrotor_rate_solver_capsule *capsule_ = nullptr;
...
#endif // MPC_CONTROLLER_ROS2_MPC_RATE_SOLVER_HPP_
